...
// Подключаем стили
echo '<link rel="stylesheet" href="../../assets/css/grade-style.css">';
...
<div class="page-container">
    ...
    <div class="page-header">
        ...
        <a href="../courses/view.php?id=<?php echo $assignment['course_id']; ?>" class="btn btn-secondary">
    ...
    <?php else: ?>
        ...
        <div class="bulk-actions">
            <h3><i class="fas fa-tasks"></i> Массовые действия</h3>
...
// Автоматически показывать форму при добавлении комментария
document.addEventListener('DOMContentLoaded', function() {
    const textareas = document.querySelectorAll('textarea[name="feedback"]');
    textareas.forEach(textarea => {
        textarea.addEventListener('focus', function() {
            this.closest('.submission-item').scrollIntoView({ 
                behavior: 'smooth', 
                block: 'center' 
            });
        });
